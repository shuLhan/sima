...
,(1			,14	,10	,3		,'Lokasi Aset'		,'ref'			,'icons/reference.svg'		,'Reference_Asset_Location'		,'')
,(1			,15	,10	,3		,'Penghapusan Aset'	,'ref'			,'icons/reference.svg'		,'Reference_Asset_Removal'		,'')
,(1			,20	,0	,0		,'Aset'				,'asset'		,''							,'Asset'						,'')
,(1			,21	,20	,3		,'Aset'				,'asset'		,'app/Asset/asset.svg'		,'Asset'						,'')
,(1			,22	,20	,3		,'Barcode'			,'barcode'		,'app/Asset/barcode.svg'	,'Asset_Barcode'				,'')
,(1			,23	,20	,3		,'Relokasi'			,'assign'		,'app/Asset/assign.svg'		,'Asset_Assign'					,'')
,(1			,24	,20	,3		,'Pemeliharaan'		,'maintenance'	,'app/Asset/maintenance.svg','Asset_Maintenance'			,'')
,(1			,25	,20	,3		,'Penghapusan'		,'removal'		,'app/Asset/removal.svg'	,'Asset_Removal'				,'')
,(1			,30	,0	,0		,'Laporan'			,'report'		,'app/Report/report.svg'	,'Report'						,'')
,(1			,31	,30	,3		,'Pengadaan'		,'report'		,'app/Report/report.svg'	,'Report_Procurement'			,'')
,(1			,32	,30	,3		,'Penghapusan'		,'report'		,'app/Report/report.svg'	,'Report_Disposal'				,'');
